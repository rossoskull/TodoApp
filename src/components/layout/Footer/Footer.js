...
import { SvgIcon, Typography, IconButton, Button, Tooltip, Zoom, SwipeableDrawer } from '@material-ui/core';
import './Footer.css';
...
class Footer extends Component {
	...
	render() {
		...
		return(
			<footer>
				{/* Open Footer Button */}
				<Button onClick={this.handleOpen} style={styles.fab} variant='fab'>
					<b>+</b>
				</Button>
				...
				>
					...
					<Typography align='center' variant='display1'>
						...
						<Tooltip placement='top' TransitionComponent={Zoom} title='Source code on GitHub'>
							<IconButton target='blank' href="http://www.github.com/rossoskull/TodoApp">
